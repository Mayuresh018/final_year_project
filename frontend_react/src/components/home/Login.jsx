...
export default function Login() {
    ...
    return (
        <Box sx={{
            ...
            backgroundPosition: "60% 15%", backgroundPosition: "60% 15%", /* Centers the image */
            ...
            <Container component="main" maxWidth="sm">
                <Box
                    sx={{
                        ...
                        py: 6,
                        marginTop: 16,
                        backgroundColor: "rgba(255, 255, 255, 0.78)", // White with 60% opacity 
                        backdropFilter: "blur(7px)",// Increased blur for a softer glass effect
                        display: "flex",
